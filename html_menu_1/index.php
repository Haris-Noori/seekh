...
<body>
	...
	<header class="header menu_2">
        ...
        <?php
            ...
            {
                ?>
                <a href="logout.php" class="btn_mobile">
                    Logout
                </a>
        <?php
            }
	...
	<main>
		...
		<div class="container-fluid margin_120_0">
			<div class="main_title_2">
				...
				<p>Choose from online video courses with new additions published every month</p>
			</div>
		...
		<div class="container margin_120_95">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<h5>Get In Touch</h5>
					<ul class="contacts">
						<li><a href="tel://+9291111128128"><i class="ti-mobile"></i> +92 91 111 128 128</a></li>
						<li><a href="http://pwr.nu.edu.pk"><i class="ti-email"></i> info@fastnuces.com</a></li>
					</ul>
					<div id="newsletter">
					<h6>Newsletter</h6>
